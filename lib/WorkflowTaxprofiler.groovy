...
class WorkflowTaxprofiler {
    ...
    public static String toolBibliographyText(params) {
            ...
            def text_classification = [
                ...
                params.run_kmcp       ? "<li>Shen, W., Xiang, H., Huang, T., Tang, H., Peng, M., Cai, D., Hu, P., & Ren, H. (2023). KMCP: accurate metagenomic profiling of both prokaryotic and viral populations by pseudo-mapping. Bioinformatics , Volume 39, Issue 1, January 2023, btac845. <a href=\"https://doi.org/10.1093/bioinformatics/btac845\">10.1093/bioinformatics/btac845</a></li>" : "",
            ].join(' ').trim()
