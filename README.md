...
2. Performs optional read pre-processing
   ...
   - Host-read removal (short-read: [BowTie2](http://bowtie-bio.sourceforge.net/bowtie2/); long-read: [Minimap2](https://github.com/lh3/minimap2), both: [Hostile](https://github.com/bede/hostile); [Deacon](https://github.com/bede/deacon))
   - Run merging
...
- [Haris Spyridis](https://github.com/haris18s)
