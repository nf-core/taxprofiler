...
def toolCitationText() {
    ...
    def text_classification = [
            ...
            params.run_centrifuger ? "Centrifuger (Song & Langmead 2023)," : "",
    ...
    def citation_text = [
        ...
        [params.run_bracken, params.run_kraken2, params.run_krakenuniq, params.run_metaphlan, params.run_malt, params.run_diamond, params.run_centrifuge, params.run_centrifuger, params.run_kaiju, params.run_motus, params.run_ganon, params.run_kmcp, params.run_sylph, params.run_melon, params.run_metacache].any() ?
            text_classification : "",
...
def toolBibliographyText() {
    ...
    def text_classification = [
        ...
        params.run_centrifuger ? "<li>Song, L. & Langmead B. (2023). Centrifuger: lossless compression of microbial genomes for efficient and accurate metagenomic sequence classification. Genome Biol.  2024 Apr 25;25(1):106. <a href=\"https://doi.org/10.1186/s13059-024-03244-4\">10.1186/s13059-024-03244-4</a></li>" : "",
