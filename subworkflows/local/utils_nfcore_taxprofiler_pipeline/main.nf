...
def toolBibliographyText() {
    ...
    def text_classification = [
        ...
        params.sylph          ? "<li>Shaw, J. & Yu, Y. W. (2024). Rapid species-level metagenome profiling and containment estimation with sylph. Nature Biotechnology. <a href="https://doi.org/10.1038/s41587-024-02412-y\">10.1038/s41587-024-02412-y</a></li>" : "",
    ].join(' ').trim()
