...
def toolCitationText() {
    ...
    def text_classification = [
            ...
            params.run_sourmash   ? "Sourmash (Irber et al. 2024)," : "",
    ...
    def citation_text = [
        ...
        [params.run_bracken, params.run_kraken2, params.run_krakenuniq, params.run_metaphlan, params.run_malt, params.run_diamond, params.run_centrifuge, params.run_centrifuger, params.run_kaiju, params.run_motus, params.run_ganon, params.run_kmcp, params.run_sourmash, params.run_sylph, params.run_melon, params.run_metacache].any() ?
            text_classification : "",
