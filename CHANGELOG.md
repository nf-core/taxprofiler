...
- [#342](https://github.com/nf-core/taxprofiler/pull/342) Fixed docs/usage to correctly list the required databases and tips to obtain Kraken2 databases, fix by @husensofteng)
