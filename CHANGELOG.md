...
- [#393](https://github.com/nf-core/taxprofiler/pull/383) Add validation check for a taxpasta taxonomy directory if --taxpasta_add_* parameters requested (♥️ to @alimalrashed for reporting, added by @jfy133)
