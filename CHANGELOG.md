...
- [#314](https://github.com/nf-core/taxprofiler/issues/314) Reorganize the CI tests into separate profiles to simplify the implementation of nf-test (fix by @LilyAnderssonLee)
