...
- [#536](https://github.com/nf-core/taxprofiler/pull/536) - Re-define contents_re for filtlong to fix the missing of filtlong from the MultiQC report (fixed by @LilyAnderssonLee)
