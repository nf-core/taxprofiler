...
- [#631](https://github.com/nf-core/taxprofiler/pull/631) For paired-end reads, DIAMOND will use only the READ1 file unless reads are merged (❤️ to @sysbiocoder for reporting and fixed by @LilyAnderssonLee)
