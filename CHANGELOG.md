...
- [#675](https://github.com/nf-core/taxprofiler/pull/675) Fixed bug of file name conflict with mixed SE and PE runs for a single sample (fixed by @LilyAnderssonLee and @jfy133)
