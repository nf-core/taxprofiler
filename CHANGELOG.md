...
- [#308](https://github.com/nf-core/taxprofiler/pull/308) Add citations/bibliographic information to the MultiQC methods text of tools used in a given pipeline run (added by @jfy133)
