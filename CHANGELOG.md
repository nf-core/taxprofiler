...
- [#372](https://github.com/nf-core/taxprofiler/pull/372/files) Update modules to use quay.io nf-core mirrored containers (♥ to @maxulysse for pointing out, fix by @LilyAnderssonLee and @jfy133)
