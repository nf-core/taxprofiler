...
### `Added`
- [#xxx](https://github.com/nf-core/taxprofiler/pull/xxx) Updated module `krakenuniq/preloadedkrakenuniq` to fix preload mechanism. (added by @muniheart with help from / ❤️ to @jfy133)
